...
function generateDynamicHtmlLayoutStructure() {
    ...
    for (let hub = 0; hub < 4; hub++) {
        ...
        workspaceHtml += `
                    <tr>
                        <td colspan="4" class="batt">
                            &nbsp;Batt&nbsp;
                            <meter id="met${hub}" min="740" low="800" optimum="900" high="1000" max="1023" value="0"></meter>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"><hr id="hr_met${hub}" /></td>
                        <td class="batt">&#x1F5F2;Batt</td>
                    </tr>
                </table>
            </div>
        `;
